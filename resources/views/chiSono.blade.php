<x-layout data-page="chi-sono">
    ...
    <section class="section2 row vh-100 text-grey justify-content-center align-items-center">
        <div class="col-12">
            <div class="row justify-content-center">
                <div class="col-8 content-height">
                    <h3 class="display-6 date">2011 - L’inizio degli studi universitari</h3>
                </div>
                <div class="col-8 content-height description">
    ...
    <section class="section3 row vh-100 text-grey justify-content-center align-items-center">
        <div class="col-12">
            <div class="row justify-content-center">
                <div class="col-8 content-height">
                    <h3 class="display-6 date">2014 - Conseguimento della Laurea in Podologia</h3>
                </div>
                <div class="col-8 content-height description">
    ...
    <section class="section4 row vh-100 text-grey justify-content-center align-items-center">
        <div class="col-12">
            <div class="row justify-content-center">
                <div class="col-8 content-height">
                    <h3 class="display-6 date">2015/2016 - Approfondimento in Biomeccanica</h3>
                </div>
                <div class="col-8 content-height description">
    ...
    <section class="section5 row vh-100 text-grey justify-content-center align-items-center">
        <div class="col-12">
            <div class="row justify-content-center">
                <div class="col-8 content-height">
    ...
    <section class="section6 row vh-100 text-grey justify-content-center align-items-center">
        <div class="col-12">
            <div class="row justify-content-center">
                <div class="col-8 content-height">
                    <h3 class="display-6 date">Dal 2018 - Collaborazione con l’equipe PBS</h3>
                </div>
                <div class="col-8 content-height description">
    ...
    <section class="section7 row vh-100 text-grey justify-content-center align-items-center">
        <div class="col-12">
            <div class="row justify-content-center">
                <div class="col-8 content-height">
                    <h3 class="display-6 date">Il presente e il futuro</h3>
                </div>
                <div class="col-8 content-height description">
    ...
    <div class="row fixed-bottom justify-content-center p-5 mouse-container">
            <div class="mouse"></div>
    </div>
</x-layout>
